...
use App\Controllers\Web\ReservationController;
...
$router->get('/app/overeni', [DashboardController::class, 'verifyNotice'], [AuthMiddleware::class]);
$router->post('/app/overeni', [DashboardController::class, 'resendVerification'], [AuthMiddleware::class]);
$router->get('/app/vstup', [DashboardController::class, 'access'], [AuthMiddleware::class]);
$router->post('/app/vstup', [DashboardController::class, 'openDoor'], [AuthMiddleware::class]);
$router->get('/app/rezervace', [ReservationController::class, 'index'], [AuthMiddleware::class]);
$router->post('/app/rezervace', [ReservationController::class, 'store'], [AuthMiddleware::class]);
$router->post('/app/rezervace/{id}/zrusit', [ReservationController::class, 'cancel'], [AuthMiddleware::class]);
$router->get('/app/clenstvi', [ProfileController::class, 'membership'], [AuthMiddleware::class]);
$router->get('/app/profil', [ProfileController::class, 'index'], [AuthMiddleware::class]);
$router->post('/app/profil', [ProfileController::class, 'update'], [AuthMiddleware::class]);
$router->post('/app/profil/heslo', [ProfileController::class, 'password'], [AuthMiddleware::class]);
$router->post('/app/profil/email', [ProfileController::class, 'email'], [AuthMiddleware::class]);
$router->post('/app/profil/avatar', [ProfileController::class, 'avatar'], [AuthMiddleware::class]);
$router->post('/app/profil/avatar/smazat', [ProfileController::class, 'deleteAvatar'], [AuthMiddleware::class]);
$router->post('/app/profil/relace/{id}/odhlasit', [ProfileController::class, 'revokeSession'], [AuthMiddleware::class]);
$router->post('/app/profil/odhlasit-vse', [ProfileController::class, 'logoutAll'], [AuthMiddleware::class]);
$router->post('/app/profil/oznameni', [ProfileController::class, 'notifications'], [AuthMiddleware::class]);
$router->get('/app/profil/export', [ProfileController::class, 'export'], [AuthMiddleware::class]);
$router->post('/app/profil/vymaz', [ProfileController::class, 'requestDeletion'], [AuthMiddleware::class]);
$router->get('/app/zabezpeceni/mfa', [ProfileController::class, 'showMfa'], [AuthMiddleware::class]);
$router->post('/app/zabezpeceni/mfa', [ProfileController::class, 'confirmMfa'], [AuthMiddleware::class]);
$router->get('/app/zabezpeceni/mfa/kody', [ProfileController::class, 'recoveryCodes'], [AuthMiddleware::class]);
