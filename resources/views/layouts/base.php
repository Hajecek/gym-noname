...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('user/style.css')) ?>?v=85">
...
<?= $content ?? '' ?>
<script nonce="<?= e($cspNonce) ?>" src="<?= e(asset('js/app.js')) ?>?v=21"></script>
<?php foreach (($pageScripts ?? []) as $src): ?>
<script nonce="<?= e($cspNonce) ?>" src="<?= e(asset($src)) ?>?v=30"></script>
<?php endforeach; ?>
